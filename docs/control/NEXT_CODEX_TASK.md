...
- Treasurer Shop V1.2 request-confirmation patch is closed (`dc9c17a`, `0a03967`).
- Next step: **treasurer-shop V1.2 production rollout plan and pre-live smoke execution**.
- docs/audit first, no immediate runtime patch.
